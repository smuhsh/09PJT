...
////////////////////////////////////////////////////////////////////////////////////////////////// --><!-- 2022-04-28 shhwang -->
<form name="detailForm" action='/product/listProduct?&menu=${param.menu=="manage"?"상품관리":"상품 목록조회"}' method="post">
<!--  <form name="detailForm" action='/product/listProduct?&menu=${param.menu=="manage"?"상품관리":"상품 목록조회"}' method="post"><!-- 2022-04-28 shhwang -->
